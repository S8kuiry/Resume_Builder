...
import { MessageSquareQuote, User2, Zap } from 'lucide-react'
...
const Testimonials = () => {
    return (
        ...
        `}</style>
            ...
            <div id="testimonials" className='scroll-mt-8 w-full'>
                ...
                <div className="w-full pt-20 flex flex-col items-center gap-3 justify-center bg-[rgba(240,253,244,0.4)]">
                    ...
                    >
                        <MessageSquareQuote className="text-green-700 w-5" />
                        <p className="text-green-700">Testimonials</p>
                    </motion.button>
                ...
                <div className=" cursor-pointer w-full bg-[rgba(240,253,244,0.4)] pt-14 marquee-row w-full mx-auto  overflow-hidden relative">
                ...
                <div className="cursor-pointer w-full bg-[rgba(240,253,244,0.4)] marquee-row w-full mx-auto  overflow-hidden relative">
